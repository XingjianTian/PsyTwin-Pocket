...
- [x] 首页、心宠及页面专属 API 完成按需分包，Mock 引擎与心宠图片资源轻量化，主包入口瘦身；分包页复用底部 TabBar，保留五页签切换入口 *(已于 2026-07-30 完成手机预览包体与导航兼容优化)*
- [x] 录制演示分支提供完整离线数据、固定 AI 回复、本地心宠状态与本地图片，并自动建立学生演示登录态 *(已于 2026-07-30 完成 `codex/demo-video-offline` 离线演示模式)*
